...
1. <a href="https://ring-operation.github.io/LinMuSi-TurboWarp-Expand/%E6%9E%97%E7%BC%AA%E6%96%AF.js" download="林缪斯.js">点击下载 林缪斯.js</a>
2. 打开 [TurboWarp](https://turbowarp.org/) 或 [Scratch](https://scratch.mit.edu/)
3. 点击左下角「添加扩展」按钮
4. 选择「加载自定义扩展」
5. 点击载入您下载的扩展文件
